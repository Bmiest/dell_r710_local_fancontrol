...
---
```
Jan 22 08:00:22 obitwo r710-fancontrol[1584152]: HOURLY STATUS | MODE=MANUAL Fan=0x0A (~10%) | CPU=39C Ambient=16C | FAN1=2280RPM FAN2=2280RPM FAN3=2280RPM FAN4=2280RPM FAN5=2280RPM
Jan 22 08:00:22 obitwo r710-fancontrol[1584153]: STATS24H | CPU(min=28C max=55C avg=38.5C) Ambient(min=16C max=17C avg=16.3C) samples=2788
Jan 22 09:00:17 obitwo r710-fancontrol[1603035]: HOURLY STATUS | MODE=MANUAL Fan=0x0A (~10%) | CPU=38C Ambient=16C | FAN1=2280RPM FAN2=2280RPM FAN3=2280RPM FAN4=2280RPM FAN5=2280RPM
Jan 22 09:00:17 obitwo r710-fancontrol[1603036]: STATS24H | CPU(min=28C max=55C avg=38.7C) Ambient(min=16C max=17C avg=16.3C) samples=2788
Jan 22 10:00:10 obitwo r710-fancontrol[1621950]: HOURLY STATUS | MODE=MANUAL Fan=0x0A (~10%) | CPU=38C Ambient=16C | FAN1=2280RPM FAN2=2280RPM FAN3=2280RPM FAN4=2280RPM FAN5=2280RPM
Jan 22 10:00:10 obitwo r710-fancontrol[1621951]: STATS24H | CPU(min=28C max=55C avg=39.0C) Ambient(min=16C max=17C avg=16.3C) samples=2788
Jan 22 11:00:05 obitwo r710-fancontrol[1640883]: HOURLY STATUS | MODE=MANUAL Fan=0x0A (~10%) | CPU=38C Ambient=16C | FAN1=2280RPM FAN2=2280RPM FAN3=2280RPM FAN4=2280RPM FAN5=2280RPM
Jan 22 11:00:05 obitwo r710-fancontrol[1640884]: STATS24H | CPU(min=36C max=55C avg=39.1C) Ambient(min=16C max=17C avg=16.3C) samples=2788
Jan 22 11:34:12 obitwo r710-fancontrol[1651645]: STATE CHANGE → AUTO | CPU=55C Ambient=16C | FAN1=2280RPM FAN2=2280RPM FAN3=2280RPM FAN4=2280RPM FAN5=2280RPM  | thresholds: CPU_ON=55 AMBIENT_ON=33
Jan 22 11:34:43 obitwo r710-fancontrol[1651802]: STATE CHANGE → MANUAL | CPU=46C Ambient=16C | FAN1=4200RPM FAN2=4080RPM FAN3=4440RPM FAN4=4200RPM FAN5=4080RPM  | Fan=0x0A (~10%) | thresholds: CPU_OFF=50 AMBIENT_OFF=30
```
